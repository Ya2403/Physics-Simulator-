...
PhysicsObject::PhysicsObject(Vector2 Velocity, Vector2 Pos, double Mass, Vector2 totalForce, bool isFixedPoint):
_velocity(Velocity), _pos(Pos), _mass(Mass), _totalForce(totalForce), _isFixedPoint(isFixedPoint)
{
